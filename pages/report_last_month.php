 ...
 * ARCHIVE REPORT: PREVIOUS MONTH SALES (report_last_month.php)      // [4] Title identifying this script as the historical monthly audit.
 * ================================================================= // [5] Visual header for administrative documentation clarity.
 * Purpose: This script targets historical data for the prior month.  // [6] Main objective: historical performance auditing.
 * It is essential for Month-over-Month (MoM) growth analysis        // [7] Task: evaluate historical route performance.
 * and evaluating historical route performance.                     // [8] Goal: business trend analysis.
...
<head>                                                               <!-- [22] Metadata and resource header section. -->
    ...
    <title>Retrospective Audit: Previous Month - Wema Travellers</title> <!-- [24] Website title for browser selection. -->
...
<body>                                                               <!-- [36] Start visible document body. -->
    ...
    <div class="report-container">                                       <!-- [39] Open the primary div container styled as a white analytical card to encapsulate the report data. -->
        <div class="back-btn-container" style="text-align: left; margin-bottom: 30px;"><a href="admin_insights.php" class="button regular-button" style="text-decoration:none; background-color: var(--purple); color: white; border-radius: 50px; display: inline-block; width: auto; padding: 12px 35px; font-weight: 700;">← Back to Insights Hub</a></div> <!-- [40] Render a hyperlink button pointing back to the admin_insights.php dashboard, styled with a purple background and rounded borders. -->
        <h2 style="color: var(--purple); margin-bottom: 5px;">📉 Historical Performance Review</h2> <!-- [41] Render the primary section header using an h2 tag with a purple text color and a trend-down emoji. -->
    ...
    </div>                                                               <!-- [59] Close the primary report container div card. -->
...
</html>                                                              <!-- [63] Formal termination of the HTML document structure. -->nt. -->
