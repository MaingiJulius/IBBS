...
<body class="<?= strtolower($_SESSION['role']) ?>-role">
    ...
    <div class="dashboard-container">                                    <!-- [37] Content constraint start. -->
        ...
        <div class="admin-options" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 25px;"> <!-- [43] Open the grid. -->
            <div class="card" style="background: #fdfaff; padding: 30px; border-radius: 12px; border: 2px solid var(--purple);"><h3>Ticket Verification</h3><p style="color: #666; margin-bottom: 20px;">Review customer tickets and authorize boarding through digital token validation.</p><a href="admin_verify_ticket.php" class="button regular-button" style="text-decoration:none; width: 100%; display: block; text-align: center; background-color: var(--purple); color: white;">Open Verification Hub</a></div> <!-- [43.1] Verification. -->
            <div class="card" style="background: white; padding: 30px; border-radius: 12px; border: 1px solid #eee;"><h3>Route Information</h3><p style="color: #666; margin-bottom: 20px;">Review schedules, destinations, and updated ticket costs for passengers.</p><a href="view_routes.php" class="button regular-button pink-background" style="text-decoration:none; width: 100%; display: block; text-align: center;">Open Schedule</a></div> <!-- [44] -->
