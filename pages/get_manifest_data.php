 ...
 * Purpose: Generates the printable HTML for a specific trip manifest.
 */
...
<body>
    ...
    <table class="passenger-table">
        ...
        <tbody>
            <?php $count = 1; while($p = $passengers->fetch_assoc()): ?>
                <tr>
                    <td><?= $count++ ?></td>
            ...
            <?php if ($passengers->num_rows === 0): ?>
                <tr>
                    <td colspan="6" style="text-align: center; padding: 40px; color: #999;">No passengers checked in for this trip.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
